...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_post'])) {
    ...
    $category = 'food'; // Set dynamically based on the current page
...
<body>
    <header id="header">
        <div class="topic">
            ...
            <div id="description">
                <div class="dText">
                    <p>Dive into the flavors of San Diego with our Food page. Share your favorite dining experiences,
                        food photos, and hidden food spots with others who love discovering the city's culinary
                        treasures. From iconic dishes to unique finds, this page is for connecting over the food that
                        makes San Diego special.</p>
                </div>
            </div>
